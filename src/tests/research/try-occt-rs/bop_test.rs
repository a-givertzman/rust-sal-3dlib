...
//! I would suggest to clone [repository](https://github.com/bschwind/opencascade-rs/tree/main) to the root folder of _try-occt-rs_ crate (see above) and then apply the changes. Tested with [this](https://github.com/bschwind/opencascade-rs/tree/76547ae0886f11ad16120bd35cef497b10f007e1) commit.
//! 
...
//! 
//! Check detailes here:
//! /home/lobanov/code/rust-proj/sal-3dlib/src/tests/research/try-occt-rs/occt-sys-changes
mod bop {
    mod cli;
