...
///   ```bash
///   cargo run -rF verbose -- volume xy 250000.0 250000.0 5000.0 models/hull_shell_centered.step
///   ```
...
///     intersect yz 200000.0 200000.0 112000.0 models/hull_shell_centered.step
///   ```
